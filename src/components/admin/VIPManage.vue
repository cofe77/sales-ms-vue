  ...
  <div>
    ...
    <div class="body">
      <el-table :data="userData" width="100%" :stripe="true" border>
        <el-table-column label="VipID" property="id" width="100" />
        <el-table-column label="姓名" property="name" width="100" />
        <el-table-column label="等级" property="level" width="100" />
    ...
    <DialogModel :show="visible" @close="close" title="新增VIP">
      <el-form
          ref="ruleFormRef"
          :model="ruleForm"
          :rules="rules"
        ...
        <el-form-item label="会员等级" prop="region">
    ...
    <DialogModel :show="visible" @close="close" title="VIP等级管理">
      <el-table :data="vipTypeData" width="100%" :stripe="true" border>
...
const handleEdit = (index: number, rowData: VipType) => {
...
const handleAdd = () => {
  console.log('vipTypeData',vipTypeData)
}
</script>
